...
<header class="">
    <div class="row align-items-center">
        <div class="col-sm-3 content-center">
            <?php
        ...
        <div class="col-sm-1">
                <span class="badge rounded-pill text-bg-secondary"><?php echo $identity->getInitials(); ?></span>
        </div>
        <div class="col-sm-1 justify-self-end">
            <?php
