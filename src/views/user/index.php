...
<div class="row mt-3">
    <div class="col justify-content-center" >
        ...
        echo Html::beginTag('a', ['href' => Url::to(['user/create']), 'class' => 'btn btn-outline-success']);
        ?>
             ...
             echo Html::beginTag('div', ['class' => implode(' ', $classes), 'fractal-cms-core-list-line' => $model->id]);
                 ...
                 echo Html::beginTag('div', ['class' => 'row align-items-center']);
                     if (Yii::$app->user->can(Constant::PERMISSION_MAIN_USER.Constant::PERMISSION_ACTION_UPDATE) === true)  {
                         echo Html::beginTag('a', ['href' => Url::to(['user/update', 'id' => $model->id]), 'class' => 'icon-link col', 'title' => 'Editer']);
                         ?>
                         <svg width="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        if (Yii::$app->user->can(Constant::PERMISSION_MAIN_USER.Constant::PERMISSION_ACTION_ACTIVATION) === true)  {
                        ...
                        if (Yii::$app->user->can(Constant::PERMISSION_MAIN_USER.Constant::PERMISSION_ACTION_DELETE) === true && Yii::$app->user->getIdentity()->getId() !== $model->id)  {
                            echo Html::beginTag('a', ['href' => Url::to(['api/user/delete', 'id' => $model->id]), 'class' => 'icon-link col user-button-delete', 'title' => 'Supprimer']);
                            ?>
                            <svg width="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
