...
<div class="row mt-3">
    <div class="col" >
        ...
        echo Html::beginTag('a', ['href' => Url::to(['parameter/create']), 'class' => 'btn btn-outline-success']);
        ?>
...
<div class="row m-3">
        <?php
            /** @var \webcraftdg\fractalCms\core\models\Parameter $model */
                ...
                echo Html::tag('div', ucfirst($model->value), ['class' => implode(' ', $className)]);
                 ...
                 echo Html::beginTag('div', ['class' => 'row align-items-center']);
                     if (Yii::$app->user->can(Constant::PERMISSION_MAIN_PARAMETER.Constant::PERMISSION_ACTION_UPDATE) === true)  {
                         echo Html::beginTag('a', ['href' => Url::to(['parameter/update', 'id' => $model->id]), 'class' => 'icon-link col', 'title' => 'Editer']);
                         ?>
                         <svg width="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        if (Yii::$app->user->can(Constant::PERMISSION_MAIN_PARAMETER.Constant::PERMISSION_ACTION_DELETE) === true)  {
                            echo Html::beginTag('a', ['href' => Url::to(['api/parameter/delete', 'id' => $model->id]), 'class' => 'icon-link col user-button-delete', 'title' => 'Supprimer']);
                            ?>
                            <svg width="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
